 ...
 */
class HALO_Slideshow_WidgetController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function buildWidgetAction()
    {
        ...
        $html = Mage::getSingleton('slideshow/widget')->getWidgetDeclaration($type, $params, $asIs);
